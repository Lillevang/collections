...
- **Documentation exception.**
  Documentation and examples of usage of the code can be generated using AI, but must be manually
  validated and verified accurate.
  Verbosity of AI generated documentation must be kept down, meaning human in the loop must edit
  the generated documentation

## Rationale

I have established these rules not because I am against AI usage, but because I want to keep Collections
an organic, human-first project. Poor usage of AI can generate tremendous amounts of low-quality code and "slop"
PRs, which can have a net-negative effect on the maintenance of the project. I hope these stricter AI rules,
can help facilitate an environment where AI can be used as a tool without compromising the work of any contributor.
